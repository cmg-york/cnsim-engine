...
public final class TxDependencyRegistry {
     ...
     * @throws IllegalArgumentException if {@code size >= Integer.MAX_VALUE || size <= 0}
     */
	 ...
	 * @throws IndexOutOfBoundsException if {@code j < 1 || j > size}
     * @throws IllegalArgumentException if {@code i < 1 || i >= j}
     */
     ...
     * @throws IndexOutOfBoundsException if {@code id < 1} or {@code id >= deps.length}
     */
     ...
     * @throws NullPointerException if {@code satisfied} is null or contains null elements
     */
     ...
     * @throws NullPointerException if {@code satisfiedBits} is null
     * @throws IndexOutOfBoundsException if {@code j < 1} or {@code j >= deps.length}
     */
