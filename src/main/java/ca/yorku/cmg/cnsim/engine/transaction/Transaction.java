...
public class Transaction {
    ...
    */
	...
	/**
     * Returns the id of the node where the transaction first appears.
    *
    * <p><b>JML Contract:</b></p>
    * <pre>
    *   //@ requires true;
    ...
    * </pre>
    *
    * @return the id of the node where the transaction first appears; {@code -1} if unspecified
    */
