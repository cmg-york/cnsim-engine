...
/**
 * Test suite for TxValueComparator.
 *
 * Test design: src/test/resources/test-design/ca/yorku/cmg/cnsim/engine/transaction/TxValueComparator.md
 */
public class TxValueComparatorTest {
    private Transaction t1;
    private Transaction t2;
    private TxValueComparator comparator;

    @BeforeEach
    void setUp() {
        t1 = new Transaction(5, 123, 150, 33);
        t2 = new Transaction(6, 124, 300, 85);
        comparator = new TxValueComparator();
    }
    ...
    @Test
    @DisplayName("Comparing equal values: t1=100 with t2=100")
    ...
    void testCompare_TC8() {
        t1.setValue(100);
        t2.setValue(200);
        Transaction t3 = new Transaction(9, 456, 300, 25);
    ...
    @Test
    @DisplayName("Comparing boundary value with valid input: t1=0, t2=positive")
    ...
    @Test
    @DisplayName("Comparing boundary value with valid input: t1=positive, t2=0")
    ...
    @Test
    @DisplayName("Comparing boundary value with valid input: t1=MAX_VALUE, t2=0")
    void testCompare_TC10_1() {
        t1.setValue(Float.MAX_VALUE);
        assertEquals(1, comparator.compare(t1, t2));
    }

    @Test
    @DisplayName("Comparing boundary value with valid input: t1=positive, t2=MAX_VALUE")
    void testCompare_TC10_2() {
        t2.setValue(Float.MAX_VALUE);
        assertEquals(-1, comparator.compare(t1, t2));
    }
}